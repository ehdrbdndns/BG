                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex">
                                    <div class="form-group col-10 pl-0">
                                        <label>FAQ 제목</label>
                                        <input type="text" class="form-control required" placeholder="FAQ 제목을 입력하세요."
                                               name="Af_Title">
                                    </div>
                                    <div class="form-group col-2">
                                        <input type="text" class="d-none required" name="Af_Category" id="Af_Category">
                                        <label>카테고리</label>
                                        <div class="dropdown">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control required" rows="10"
                                              name="Af_Contents" placeholder="FAQ 내용을 입력하세요."></textarea>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <div></div>
                                    <div class="d-flex">
                                        <div class="btn btn-danger" onclick="cancel()">취소</div>
                                        <div class="btn btn-primary ml-3" id="saveFaq">저장</div>
                                    </div>
                                </div>
                            </div>
                        </form>
