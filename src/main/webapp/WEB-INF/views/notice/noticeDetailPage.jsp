                        ...
                        <div class="card-body">
                            <form id="Form">
                                ...
                                <div class="form-group col-10 pl-0">
                                    <label>공지 제목</label>
                                    <input type="text" class="form-control required" placeholder="공지 제목을 작성해주세요."
                                           name="An_Title" value="${noticeInfo.an_Title}">
                                    <input type="text" class="d-none" name="An_No" value="${noticeInfo.an_No}">
                                </div>
                                <div class="form-group">
                                    <label>공지 내용</label>
                                    <textarea class="form-control required" name="An_Contents" id="" rows="5"
                                              placeholder="공지 내용을 작성해주세요.">${noticeInfo.an_Contents}</textarea>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <div></div>
                                    <div class="d-flex">
                                        <div class="btn btn-danger mr-2" onclick="cancel()">취소
                                        </div>
