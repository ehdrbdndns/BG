                        ...
                        <div class="card-body">
                            <form id="Form">
                                ...
                                <div class="form-group col-10 pl-0">
                                    <label>공지 제목</label>
                                    <input type="text" class="form-control required" placeholder="공지 제목을 작성해주세요." name="An_Title">
                                </div>
                                <div class="form-group">
                                    <label>공지 내용</label>
                                    <textarea class="form-control required" name="An_Contents" id="" rows="5" placeholder="공지 내용을 작성해주세요."></textarea>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <div></div>
                                    <div class="d-flex">
                                        <div class="btn btn-danger mr-2" onclick="cancel()">취소</div>
                                        <div class="btn btn-primary" id="saveAnnounce">저장</div>
                                    </div>
                                </div>
                            </form>
                        </div>
